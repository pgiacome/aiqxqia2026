...
The definitions, statements and proofs in this paper, and the decisions about
what is correct, are the author's own. During the preparation of this work the
author used Claude (Anthropic) for LaTeX editing, for drafting and revising
prose, and for checking citations. After using this tool the author reviewed
